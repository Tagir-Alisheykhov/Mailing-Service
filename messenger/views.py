...
from .services import (
    ...
    get_mailings_attempt, create_msg_validation
)
...
class MessageUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на редактирование данного сообщения ;] ')
...
class MessageDetailView(DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на просмотр данного сообщения ;] ')
...
class MessageDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на удаление данного сообщения ;] ')
...
class MailingCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs['message_form'] = MessageForm(self.request.POST or None, prefix='message')
        return kwargs
    ...
    def dispatch(self, request, *args, **kwargs):
        if request.user.has_perm('messenger.can_disable_mailing') and not request.user.is_superuser:
...
class MailingDetailView(LoginRequiredMixin, DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на просмотр данной рассылки ;] ')
...
class MailingUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на обновление данной рассылки ;] ')
...
class MailingDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на удаление данной рассылки ;] ')
...
class RecipientUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseForbidden('403 - У вас нет прав на обновление получателей ;] ')
